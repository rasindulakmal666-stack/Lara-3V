...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "HYYFVJBL#Ioakkt7MmcouU60rtxOvhrOm6lXQdG1OkIZDCspeNTs", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94714802870",
DEV: process.env.DEV || "94714802870",
